...
export default function PendingReviewBanner() {
  ...
  return (
    <Link to="/presences" data-testid="pending-review-banner">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-amber-900">
              {count} présence{count > 1 ? 's' : ''} à vérifier
            </p>
            <p className="text-xs text-amber-700">
              Des participants nécessitent votre vérification avant action financière
            </p>
          </div>
        </div>
